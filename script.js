...
function displayTime() {
    ...
    document.getElementById("showTime").innerHTML = hour + ":" + mins + ":" + secs + ":" + AMPM;
}
...
document.getElementById("setAlarmButton").addEventListener("click", function () {
    ...
    let data = length.toString() + ") " + selectHour + ":" + selectMin + ":" + selectSec + ":" + selectAMPM;
    ...
    setInterval(() => {
        ...
        if (arr.length != 0 && arr[0][0] == hr && arr[0][1] == min && arr[0][2] == sec && arr[0][3] == selectAMPM) {
